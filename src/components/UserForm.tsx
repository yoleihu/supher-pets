  ...
  return (
    <div className="flex flex-col justify-center items-center mx-4 lg:mx-0">
      <div className="min-w-fit lg:min-w-[] max-w-lg w-2/5">
        {(isRegister || isLogin) && (
          <div className="justify-around flex mb-5">
            <ButtonUser
              ...
              label={"Tutor"}
              onChangeUser={() => {
                setIsGuardian(true), setIsBloodCenter(false);
              }}
            />
            <ButtonUser
              isBloodCenter={isBloodCenter}
              label={"Hemocentro"}
              onChangeUser={() => {
                setIsGuardian(false), setIsBloodCenter(true);
              }}
            />
          </div>
        )}
        ...
        <div
          className={`bg-white shadow lg:px-10 lg:py-7 px-6 py-4 h-fit rounded-3xl`}
        >
          {isRegister && (
            <>
              <div className="flex flex-col gap-2">
                <h2 className="lg:text-2xl text-xl font-semibold text-zinc-800 text-center">
                  Cadastro {isGuardian ? "Tutor" : "Hemocentro"}
                </h2>
                <Formik
                    ...
                    <Form className="flex flex-col gap-4 justify-center items-center">
                      ...
                      {isGuardian ? (
                        <Input
                          ...
                          placeholder="CPF"
                          type={"text"}
                          errors={errors.cpf ?? null}
                          touched={touched.cpf ?? null}
                        />
                      ) : (
                        <Input
                          id="cnpj"
                          ...
                          placeholder="CNPJ"
                          type={"text"}
                          errors={errors.cnpj ?? null}
                          touched={touched.cnpj ?? null}
                        />
                      )}
                      <Input
                        id="email"
                      ...
                      <Input
                        ...
                        touched={touched.terms ?? null}
                      />

                      <button
                        className="bg-sky-800 text-white hover:bg-sky-700 rounded-full h-10 w-2/4 mt-5"
                        type="submit"
                      >
                        Cadastrar
                      </button>
          ...
          {isLogin && (
            <>
              <div className="flex flex-col gap-2">
                <h2 className="lg:text-2xl text-xl font-semibold text-zinc-800 text-center">
                  Login {isGuardian ? "Tutor" : "Hemocentro"}
                </h2>
                <Formik
                  ...
                  {({ errors, touched }) => (
                    <Form className="flex flex-col justify-center gap-4">
                      ...
                      <div className="w-full flex flex-col gap-1">
                        ...
                        <button
                          type="button"
                          className="text-sky-800 underline text-sm right-0 w-fit self-end"
                      ...
                      <button
                        className="bg-sky-800 text-white hover:bg-sky-700 rounded-full h-10 w-2/4 mt-2 self-center"
                        type="submit"
                      >
                        Login
                      </button>
          ...
          {isRecoverPassword && (
            <>
              <div className="flex flex-col lg:gap-6">
                <h2 className="lg:text-3xl text-2xl font-semibold text-zinc-800 text-center">
                  Nova senha
                </h2>
                <Formik
